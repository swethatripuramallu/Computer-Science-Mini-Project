...
public class TeacherSubmissionPane implements Runnable {
    ...
    public TeacherSubmissionPane(String username, String password, String student, int submissionNumber) {
