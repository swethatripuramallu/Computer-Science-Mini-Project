...
public class StudentAccountPane implements Runnable {
    ...
    public StudentAccountPane(String username, String password) {
    ...
    public void changeUser(String username) {
        try {
            ...
            oos.flush();
            oos.writeObject("changeStudentUsername");
            oos.flush();
    ...
    public void changePass(String password) {
        try {
            ...
            ObjectOutputStream oos = new ObjectOutputStream(socket.getOutputStream());
            oos.flush();
            oos.writeObject("changeStudentPassword");
            oos.flush();
            oos.writeObject(this.username);
            oos.flush();
    ...
    public void delete() {
        try {
            ...
            ObjectOutputStream oos = new ObjectOutputStream(socket.getOutputStream());
            oos.flush();
            oos.writeObject("deleteStudentAccount");
            oos.flush();
            oos.writeObject(this.username);
            oos.flush();
        } catch (Exception e) {
